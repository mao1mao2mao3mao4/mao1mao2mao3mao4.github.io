...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_ActinoOverrideStringProperty = serializedObject.FindProperty("m_ActinLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(m_CostomizeUILabel, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_ActionOverrideProperty);
                if (m_RebindActionUI.m_OverrideActionLabel)
                {
                    EditorGUILayout.PropertyField(m_ActinoOverrideStringProperty);
                }
            }
        ...
        private SerializedProperty m_ActinoOverrideStringProperty;
        ...
        private GUIContent m_CostomizeUILabel = new GUIContent("Costomize UI");//新加内容
