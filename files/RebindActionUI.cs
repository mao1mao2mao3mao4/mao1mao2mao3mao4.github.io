...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void ResetBinding(InputAction action, int bindingIndex)
        {
            ...
            foreach (var inputAction in action.actionMap.actions)
            {
                ...
                for (int i = 0; i < inputAction.bindings.Count; i++)
                {
                    ...
                    {
                        inputAction.ApplyBindingOverride(i,oldOverridePath);
                    }
                }
            }
        }
        ...
        [Tooltip("勾选后映射的UI展示自定义内容")] public bool m_OverrideActionLabel;

        [Tooltip("自定义名称")] [SerializeField] private string m_ActinLabelString;
        ...
        private void UpdateActionLabel()
        {
            if (m_ActionLabel != null)
            {
                ...
                {
                    m_ActionLabel.text = m_ActinLabelString;
                }
                else
                {
                    m_ActionLabel.text = action != null ? action.name : string.Empty;
                    m_ActinLabelString = string.Empty;
                }
            }
        }
